...
- **Title**: Quality
- **Identifier**:
  <https://stac.linz.govt.nz/v0.0.12/quality/schema.json>
...
- Examples:
  - [Collection example](https://stac.linz.govt.nz/v0.0.12/quality/examples/collection.json): Shows the basic usage of the
    extension in a STAC Collection
- [JSON Schema](https://stac.linz.govt.nz/v0.0.12/quality/schema.json)
