...
- **Identifier**: <https://stac.linz.govt.nz/v0.0.12/historical-imagery/schema.json>
...
- Examples:
  - [Collection example](https://stac.linz.govt.nz/v0.0.12/historical-imagery/examples/collection.json): Shows the basic usage of the
    extension in a STAC Collection
  - [Item example](https://stac.linz.govt.nz/v0.0.12/historical-imagery/examples/item.json): Shows the basic usage of the extension
    in a STAC Item
- [JSON Schema](https://stac.linz.govt.nz/v0.0.12/historical-imagery/schema.json)
