...
| linz:created                 | string | **REQUIRED**. Creation date and time of the corresponding data (see below), in UTC.                                                                                                                                                                                                                                                              |
| linz:updated                 | string | **REQUIRED**. Date and time the corresponding data (see below) was updated last, in UTC.                                                                                                                                                                                                                                                         |
