...
- **Identifier:**
  <https://stac.linz.govt.nz/v0.0.14/linz/schema.json>
...
- Examples:
  - [Collection example](https://stac.linz.govt.nz/v0.0.14/linz/examples/collection.json): Shows the basic usage of the
    extension in a STAC Collection
  - [Item example](https://stac.linz.govt.nz/v0.0.14/linz/examples/item.json): Shows the basic usage of the extension
    in a STAC Item
- [JSON Schema](https://stac.linz.govt.nz/v0.0.14/linz/schema.json)
- [Changelog](https://stac.linz.govt.nz/v0.0.14/linz/CHANGELOG.md)
...
- [quality](https://stac.linz.govt.nz/v0.0.14/quality)
